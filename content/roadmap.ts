...
export type Visualizer = "arrays" | "big-o" | "filas" | "hash-table" | "intervals" | "listas-ligadas" | "pilhas" | "prefix-sum" | "recursao" | "recursao-funcional" | "skip-list" | "sliding-window" | "strings" | "sub-types" | "two-pointers";
