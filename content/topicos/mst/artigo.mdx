...
Se esse código parece o [Dijkstra](/topicos/dijkstra), é porque quase é. A única diferença é o que vai na fila: o Dijkstra empurra `dist[u] + peso` (o custo **acumulado desde a origem**), e o Prim empurra `peso` (o custo **daquela aresta só**). Um constrói caminhos, o outro constrói uma rede.
...
Com este tópico o grupo de grafos fecha o caminho principal: [representação](/topicos/grafos-intro), [percursos](/topicos/dfs-bfs), caminho mínimo com [Dijkstra](/topicos/dijkstra), [Bellman-Ford](/topicos/bellman-ford) e [A*](/topicos/a-star), [ordem de dependências](/topicos/topological-sort) e agora conectividade de custo mínimo.
