...
O exemplo acima tem tamanho travado. Existe também a **janela variável**, em que a direita sempre avança e a esquerda só se move enquanto a janela for inválida, é assim que você resolve "maior substring sem repetir caracteres" ou "menor subarray com soma ≥ alvo". Veja essa versão na página [Sliding Window (Dynamic)](/topico/sliding-window-dynamic).
