...
Com 8 elementos, o shell sort quase sempre **perde**. Com 32, ele já ganha com folga numa entrada embaralhada (138 comparações contra 313). Com 128, a diferença é de quatro vezes (993 contra 4.396). O ponto de virada fica por volta de uma dúzia de elementos, e não é um número mágico: é onde `n` cresce o bastante para o termo quadrático do insertion sort superar o custo das rodadas extras.
