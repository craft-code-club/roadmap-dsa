...
O próximo passo é aplicar isso em algo concreto: veja como [Two Pointers](/topico/two-pointers) transforma um O(n²) em O(n), e como a [Sliding Window](/topico/sliding-window) evita recalcular o que já foi calculado.
