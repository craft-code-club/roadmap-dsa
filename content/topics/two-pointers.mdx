...
- **Na mesma direção**, os dois começam à esquerda e avançam em ritmos diferentes (lento/rápido). É o motor da [Sliding Window](/topico/sliding-window) e de detecção de ciclo em listas ligadas.
