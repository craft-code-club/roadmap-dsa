...
Na prática, a escolha mais comum é a **mediana de três** (primeiro, meio e último), muitas vezes combinada com sorteio. Ela custa duas comparações a mais por partição, um preço O(1) que some na conta assintótica, e elimina de uma vez os dois casos ordenados.
