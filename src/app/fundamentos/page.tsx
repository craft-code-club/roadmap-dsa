...
import { ROADMAPS, EXTRA_CARDS, STANDALONES } from "@content/roadmaps";
...
export function generateMetadata(): Metadata {
  return pageMetadata({
    ...
    description: `Os fundamentos de algoritmos e estruturas de dados em português, do Big O aos grafos: ${TOTAL_TOPICS} tópicos na ordem certa, com visualização, vídeo e problemas do LeetCode.`,
    ogTitle: "Fundamentos de Algoritmos e Estruturas de Dados",
    ogDescription: `${TOTAL_TOPICS} tópicos na ordem certa de estudo, do Big O aos grafos. Visual, gratuito e em português.`,
    path: "/fundamentos/",
  });
}
