...
Na versão [fixa](/topico/janela-deslizante-fixa), a janela sempre tinha `k` elementos. Aqui o tamanho **varia**: o enunciado define quando uma janela é *válida* (soma ≤ k, no máximo um zero, produto < k, caracteres sem repetir…) e pede a maior, ou a menor, janela válida.
...
<JanelaVisualizer variant="dinamica" />
